          ...
          <article className="lg:mt-10 lg:mb-10">
            ...
            <ul>
              <li className="p-4 tracking-wide ">
                ...
                answer several questions regarding a trip that you are planning
                to take. For example: where are you travelling to and where
                from.
              </li>
              <li className="p-4 tracking-wide ">
          ...
          <article className="lg:mt-10 lg:mb-10">
            ...
            <ul>
              <li className="p-4 tracking-wide">
                ...
                meant if you are citizen of the country you are travelling to or
                maybe a tourist, and as well, for example, if you had to stay in
          ...
          <article className="lg:mt-10 lg:mb-10">
            ...
            <ul>
              <li className="p-4 tracking-wide">
                ...
                answering the questions you can add a comment, and lastly press
